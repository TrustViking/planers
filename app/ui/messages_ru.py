...
# Особенность площадки по каналу (раздел «Особенности площадки» отчёта, в консоль не идёт): служебный эфир
# «Начать эфир сейчас» без времени старта (выгрузки 18-09-2026, задача 5n-C).
NOTE_UNDATED_BROADCAST: Final[str] = (
    ...
    "сам при заходе в панель трансляций канала; планер его со слотами не сверяет и не трогает, в списке трансляций "
    "Студии он не виден"
)
